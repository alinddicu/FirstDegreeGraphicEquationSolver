namespace FirstDegreeGraphicEquationSolver.Drawers
{
    ...
    public class GraphLineDrawer
    {
        ...
        public void Draw(Graphics graphics, GraphLine line, Pen pen)
        {
            var drawingPoint1 = new Point(_pointConverter.GetPanelWidth(), line.GetY(_pointConverter.GetPanelWidth()));
            var drawingPoint2 = new Point(-_pointConverter.GetPanelWidth(), line.GetY(-_pointConverter.GetPanelWidth()));
